...
export const CN_MASKS: BuiltinMask[] = [
  {
    ...
    context: [
      ...
      },
      {
        ...
        role: "user",
        content:
          "请指导我如何一步一步将项目部署的流程，或者解答一个具体的编程相关问题，说明相关流程是怎么工作的：",
        date: "",
      },
      {
        id: "deploy-2",
        role: "assistant",
        content:
          "好的！请告诉我您的具体问题或项目详情，例如：您使用的是哪种技术栈（Django/Vue、Spring Boot/React 等）？需要帮助修改哪些配置文件？或者您遇到什么编程问题？或者您有什么学习问题？🚀 我将为您提供清晰的步骤和最佳实践！",
        date: "",
      },
    ],
    modelConfig: {
